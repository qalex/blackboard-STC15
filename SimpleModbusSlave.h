...
// modbus_configure modified to reduct the ram used for the 8051 - configured via #DEFINES
void modbus_configure(byte _slaveID, byte _TxEnablePin, unsigned int _holdingRegsSize);
